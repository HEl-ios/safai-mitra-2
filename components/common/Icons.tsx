...
export const LogoIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="M17 8c.6-1.6.6-3.2 0-4.8C16.1 2.4 15.2 2 14.5 2c-.8 0-1.5.5-2 1.3-.5-.8-1.2-1.3-2-1.3-.7 0-1.6.4-2.5 1.2-.6 1.6-.6 3.2 0 4.8C6.6 9.4 6 10.7 6 12c0 1.3.6 2.6 1.5 4 .9 1.4 2.2 2.5 3.8 3.2.3.2.7.2 1 0 1.6-.7 2.9-1.8 3.8-3.2.9-1.4 1.5-2.7 1.5-4 .1-1.3-.5-2.6-1.5-4z" />
  </svg>
);
...
export const RecycleIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="M7 19H4.815a1.83 1.83 0 0 1-1.57-2.925L5.5 12.236" />
    <path d="M12.5 15.025V12.236" />
    <path d="M10.185 7H12.5v2.789" />
    <path d="m10.185 7-2.26 1.305" />
    <path d="M14.75 16.236 17 15l2.25 1.236" />
    <path d="M17 15V5a2 2 0 0 0-2-2h-1" />
    <path d="m14 9-2.25 1.236" />
    <path d="M19.185 10.925 17 12.236" />
    <path d="M12.5 15.025 10.25 16.26" />
    <path d="m7 5 2.25 1.236" />
    <path d="M7 5h2.185" />
    <path d="M7 5V3.5A1.5 1.5 0 0 1 8.5 2" />
    <path d="M19.185 10.925A1.83 1.83 0 0 1 20.755 8" />
  </svg>
);
...
// Note: This is now a Lightbulb icon for quizzes, but component name is kept for backward compatibility
...
// Note: This is now a Bot icon for the chatbot, but component name is kept for backward compatibility
...
export const GemIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
      <path d="M6 3h12l4 6-10 13L2 9Z"/><path d="M12 22V9"/>
...
// Fix: Moved BellIcon, BellOffIcon, and SendIcon here from NotificationManager.tsx
...
export const BellOffIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        ...
        <path d="M17 17H3s3-2 3-9a4.24 4.24 0 0 0 -.3-1.7" />
        <path d="M10.3 21a1.94 1.94 0 0 0 3.4 0" />
        <path d="m2 2 20 20" />
    </svg>
);
