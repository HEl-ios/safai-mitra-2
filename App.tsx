...
import { View, Badge, BadgeSlug, HistoryItem, WasteClassificationResult, ReportHistoryItem, ReportStatus, PenaltyStatus, Community, CommunityMember, CommunityMessage, Building, Penalty, Warning } from './types.ts';
  ...
  const renderView = () => {
    ...
    switch (currentView) {
      ...
      case View.ADMIN_DASHBOARD:
        return <AdminDashboard reports={reports} updateReportStatus={updateReportStatus} updateReportPenaltyStatus={updateReportPenaltyStatus} assignBuildingToReport={assignBuildingToReport} buildings={buildings} addWarningToBuilding={addWarningToBuilding} addPenaltyToBuilding={addPenaltyToBuilding} />;
